...
export default function QRScannerPage() {
    ...
    const startScanner = async () => {
        ...
        try {
            ...
            if (errorMsg.includes("Permission") || errorMsg.includes("NotAllowedError")) {
                ...
                setError(
                    "HARDWARE_LOCKED: THE CAMERA IS BUSY. PLEASE CLOSE OTHER TABS OR REFRESH THE BROWSER."
                );
    ...
    const handleAttendance = async () => {
        ...
        try {
            ...
            setError(err?.message || "TRANSACTION_FAILED: UNKNOWN ERROR.");
        } finally {
            setIsUpdating(false);
        }
    };
                ...
                <main className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 items-start pb-20">
                    <div className="lg:col-span-6 flex flex-col items-center">
                        ...
                        >
                            ...
                            <div
                                className={`absolute -inset-1 border-2 rounded-[2.2rem] md:rounded-[3.5rem] pointer-events-none transition-all duration-1000 ${participant
                                ...
                                <AnimatePresence>
                                    {!isCameraStarted && (
                                        ...
                                        >
                                            ...
                                            <div>
                                                <h4 className="text-xl md:text-2xl font-black uppercase tracking-tight text-white mb-3 md:mb-4">
                                                    LENS AUTH REQUIRED
                                                </h4>
                                                <p className="text-white/30 text-[9px] md:text-[10px] font-bold uppercase tracking-[0.2em] leading-relaxed max-w-[200px] md:max-w-[220px] mx-auto">
                                                    Manual gesture required for optical initialization.
                                                </p>
                                            </div>
                            ...
                            <div className="mt-8 md:mt-12 flex flex-col items-center gap-4 md:gap-6">
                                <div className="px-6 md:px-8 py-2.5 md:py-3 bg-[#0a0a0a] border border-white/5 rounded-full flex items-center gap-3 md:gap-4 shadow-2xl">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.3em] text-white whitespace-nowrap">
                                            SYSTEM_LIVE
                                        </span>
                                    </div>
                                ...
                                <button
                                    ...
                                    className="text-[8px] md:text-[9px] font-black uppercase tracking-[0.4em] text-white/10 hover:text-amber-500 transition-colors"
                                >
                                    FORCE_RESET_LENS
                                </button>
                            </div>
                            ...
                            {participant ? (
                                        ...
                                        <div className="flex flex-col gap-6 mb-12">
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-4 md:p-6 flex flex-col justify-center">
                                                    <p className="text-[8px] md:text-[9px] font-black text-white/30 uppercase tracking-[0.3em] mb-1">
                                                        Register Number
                                                    </p>
                                                    <p className="text-sm md:text-base font-black text-amber-500 tracking-widest uppercase">
                                        ...
                                        {lastAction ? (
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-2 mb-1">
                                                    ...
                                                    />
                                                    <span className="text-[7px] font-black tracking-[0.3em] text-white/40 uppercase">
                                                        VISHAKA_AUTHORIZED
                                                    </span>
                                                </div>
                                ...
                                >
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <p className="text-red-500/80 text-[10px] font-black uppercase tracking-[0.3em] leading-relaxed max-w-[280px] mx-auto">
                                            {error}
                                        </p>
                                    </div>
                                ...
                                <div className="w-full h-full flex flex-col items-center justify-center text-center gap-8 md:gap-12 px-4 md:pr-6">
                                    ...
                                    <div className="space-y-4">
                                        <h4 className="text-sm md:text-xl font-black uppercase tracking-[0.5em] text-white/5 italic">
                                            System_Ready
                                        </h4>
                                    </div>
                                </div>
            ...
            <div className="fixed bottom-6 md:bottom-10 left-0 w-full flex justify-center px-6 lg:hidden z-50">
                <nav className="bg-[#0f0f0f]/90 backdrop-blur-2xl border border-white/10 px-6 md:px-8 py-4 md:py-5 rounded-full flex items-center gap-6 md:gap-12 shadow-3xl overflow-x-auto no-scrollbar max-w-full">
                    ...
                    <button
                        ...
                        className="text-white/40 hover:text-[#f43f5e] transition-colors flex-shrink-0"
                    >
                        <LogOut size={24} />
                    </button>
                </nav>
                    ...
                    >
                        <div className="bg-[#0a0a0a]/90 backdrop-blur-2xl border border-amber-500/30 rounded-2xl px-6 py-4 flex items-center gap-4 shadow-[0_20px_50px_rgba(245,158,11,0.2)]">
                            ...
                            <div className="flex flex-col">
                                <span className="text-[10px] font-black text-amber-500 tracking-[0.3em] uppercase underline-offset-4 decoration-amber-500/20 underline">
